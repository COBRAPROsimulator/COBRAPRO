function Un = Un_Graphite_Si_comsolValidation(theta)
% Un_Graphite_Si_comsolValidation is the experimentally determined open-circuit potential (OCP)
% of the Graphite-Silicon anode from [1]. OCP was determined from half-cell GITT
% tests in [1]. Used in test_2_comsolValidation.m script to check the code
% against COMSOL
%
% Reference:
