function Kappa_eff = Kappa_eff_Chen2020_comsolValidation(ce,param,domain)
% Kappa_eff_Chen2020_comsolValidation evaluates the effective electrolyte conductivity as a
...
%
%   Output:
%       Kappa_eff: effective electrolyte conductivity [S/m]
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
